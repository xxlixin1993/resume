...
<body>
	<form method='post' action='/index.php/Admin/Classify/deleteAll'>
		<table class="table" cellspacing="1" cellpadding="2" width="99%"
			...
			<tbody>
				...
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td class="td_bg"><?php echo ($vo["value"]); ?></td>
					<td class="td_bg">
						<a href="/index.php/Admin/Classify/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
					</td>
					<td class="td_bg">
